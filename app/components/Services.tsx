...
const Services = () => {
    return (
        <div id='Services' className='w-full px-[12%] py-10 scroll-mt-20'>
            ...
            <p className='max-w-2xl mx-auto font-ovo text-center mt-5 mb-12'>Blending design and code, I craft smooth,
                modern web experiences—turning ideas into interactive realities with React, Next.js and a passion for clean UI </p>
